...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1f15e823400681079140cb0797ea855',//原ID地址为02ab3b8678004aa69e9e415905ef32a5，已更换为自己的ID,如果需添加英文，逗号隔开，输入en:7c1d570661754c8fbc568e00a01fd70e，冒号后为ID
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Fans', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || ' 我是下雨天，街角边，快乐的小神仙🎉', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://fans8.fans', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,fans,交易,赚钱,好玩,有趣', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20250389号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=20250389/', // 备案查询链接，如果用了萌备等备案请在这里填写https://beian.miit.gov.cn
  ...
  ...require('./conf/guestbook.config'), // 留言墙配置
  ...
  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || [
    {
      name: '留言墙',
      href: '/guestbook',
